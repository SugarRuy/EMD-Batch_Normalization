...
def getMySignatures() :
    d = np.load('withoutBN.npz')
    features1 = d['arr_0'].reshape(50,1*28*28).transpose()
    features2 = d['arr_1'].reshape(50,32*24*24).transpose()

    weights1 = np.array(784*[1/784])
    weights2 = np.array(18432*[1/18432])
